...
export function StatCard({
  ...
  const content = (
    <motion.div
      ...
      className="group relative bg-white rounded-2xl border border-slate-200 p-5 hover:shadow-xl hover:border-slate-300 transition-all cursor-pointer overflow-hidden h-full"
    >
