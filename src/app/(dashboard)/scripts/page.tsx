  ...
  return (
    <>
      ...
      <main className="p-4 sm:p-6 lg:p-8 max-w-[1800px] mx-auto">
        ...
        {/* Modal Wizard de création de script */}
        {showWizard && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-7xl h-[90vh] overflow-hidden flex flex-col">
              ...
              <div className="bg-gradient-to-r from-brand-orange to-brand-orange-light p-6 border-b-4 border-brand-orange">
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-2xl font-bold text-white">
                      Créateur de Script Guidé
                    </h2>
                    <p className="text-white/90 text-sm mt-1">Crée un script professionnel en quelques étapes</p>
                  </div>
                  <button
