  ...
  return (
    <section id="offers" className="relative overflow-hidden px-4 py-14 sm:px-5 sm:py-20 md:px-6 md:py-24 section-premium scroll-mt-16 sm:scroll-mt-28 md:scroll-mt-32">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mt-8 sm:mt-10 md:mt-12 grid gap-5 sm:gap-8 md:grid-cols-2 lg:grid-cols-3 px-0 sm:px-0">
          {OFFERS.map((offer, index) => {
            const isPopular = index === 1; // Pack 2 est généralement le plus populaire (Business Growth)
            return (
              <div
                key={offer.title}
                className={`group relative flex h-full flex-col rounded-2xl transition-all duration-200 sm:duration-300 active:scale-[0.99] sm:hover:-translate-y-2 ${
                  isPopular 
                    ? 'border-2 border-orange-500/50 bg-gradient-to-br from-white/80 via-white/70 to-orange-50/50 shadow-xl sm:shadow-2xl shadow-orange-500/15 sm:shadow-orange-500/20 sm:hover:shadow-[0_40px_90px_rgba(253,89,4,0.25)]' 
              ...
              >
                ...
                <div className={`space-y-6 sm:space-y-8 relative z-10 ${isPopular ? 'px-5 sm:px-6 md:px-8 py-8 sm:py-10 md:py-12' : 'px-5 sm:px-6 md:px-8 py-7 sm:py-8 md:py-10'}`}>
                    ...
                    <div>
                      <div className="flex items-baseline gap-2 sm:gap-2">
                        ...
                        <div className="flex flex-col">
                          <span className="text-sm font-bold text-gray-900">CHF</span>
                          <span className="text-xs font-medium text-gray-500">/{offer.period}</span>
                        </div>
                      </div>

                      <div className="mt-4 p-3 rounded-xl bg-orange-500/5 border border-orange-500/10">
                        <p className="text-xs font-bold text-orange-800 uppercase tracking-tight mb-1">Objectif</p>
                  ...
                  <div className="space-y-4 sm:space-y-4">
                    ...
                    <div className="pt-2">
                      <p className="text-[11px] font-bold text-orange-600 uppercase leading-tight italic">
                        {offer.target}
                      </p>
                    </div>
                  </div>
